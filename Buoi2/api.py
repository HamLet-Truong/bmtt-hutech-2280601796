...
from cipher.transposition import TranspositionCipher  # Thêm TranspositionCipher
...
transposition_cipher = TranspositionCipher()  # Khởi tạo TranspositionCipher
